...
```text
src/atlas/retrieval/retrievers/dense.py
src/atlas/retrieval/retrievers/bm25.py
...
| BM25 retriever | `retrieval/retrievers/bm25.py` | retrieve/query | lexical rank/score | sparse hit@k |
